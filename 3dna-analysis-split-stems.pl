...
$fix3dna =
"/home/server/FAHdata/PKNOT-DATA/old.PKNOT.analysis/scripts/fix_3DNA_output.pl";
...
if ($proj == 1798) {
    $ndxfile =
      "/home/server/FAHdata/PKNOT-DATA/old.PKONT.analysis/2A43_luteo.ndx";
    $tprfile =
      "/home/server/FAHdata/PKNOT-DATA/PROJ1798/RUN0/CLONE0/frame0.tpr";
    $natbpfile =
"/home/server/FAHdata/PKNOT-DATA/old.PKNOT.analysis/carolyn_native_base_pairs_luteo";
}
if ($proj == 1799) {
    $ndxfile =
      "/home/server/FAHdata/PKNOT-DATA/old.PKNOT.analysis/2G1W_aquifex.ndx";
    $tprfile =
      "/home/server/FAHdata/PKNOT-DATA/PROJ1799/RUN0/CLONE0/frame0.tpr";
    $natbpfile =
"/home/server/FAHdata/PKNOT-DATA/old.PKNOT.analysis/carolyn_native_base_pairs_aqui";
}
...
while ($currentrun < $maxrun) {
    ...
    while ($currentclone < $maxclone) {
        ...
        $workdir =
"/home/server/FAHdata/PKNOT-DATA/PROJ$proj/RUN$currentrun/CLONE$currentclone/";
        chdir $workdir;
        ...
        if ($numxtcfiles > 0) {
            ...
            system(
"echo 1 1 | g_rms -s $tprfile -f $outxtc -n $ndxfile >& /dev/null"
            );
